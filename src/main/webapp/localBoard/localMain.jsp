...
<a href='localssList.jsp?local=<%=URLEncoder.encode("전북", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus2') onmouseout=mus_off('mus2') onclick=smenu_click('mus2')>
<img src='map/m063.gif' alt='' border='0' name='mus2' class='list2' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("경남", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus3') onmouseout=mus_off('mus3') onclick=smenu_click('mus3')>
<img src='map/m055.gif' alt='' border='0' name='mus3' class='list3' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("강원", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus4') onmouseout=mus_off('mus4') onclick=smenu_click('mus4')>
<img src='map/m033.gif' alt='' border='0' name='mus4' class='list4' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("충남", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus5') onmouseout=mus_off('mus5') onclick=smenu_click('mus5')>
<img src='map/m041.gif' alt='' border='0' name='mus5' class='list5' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("경기", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus6') onmouseout=mus_off('mus6') onclick=smenu_click('mus6')>
<img src='map/m031.gif' alt='' border='0' name='mus6' class='list6' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("충북", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus7') onmouseout=mus_off('mus7') onclick=smenu_click('mus7')>
<img src='map/m043.gif' alt='' border='0' name='mus7' class='list7' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("경북", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus8') onmouseout=mus_off('mus8') onclick=smenu_click('mus8')>
<img src='map/m054.gif' alt='' border='0' name='mus8' class='list8' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("제주", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus9') onmouseout=mus_off('mus9') onclick=smenu_click('mus9')>
<img src='map/m064.gif' alt='' border='0' name='mus9' class='list9' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("서울", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus10') onmouseout=mus_off('mus10') onclick=smenu_click('mus10')>
<img src='map/m02.gif' alt='' border='0' name='mus10' class='list10' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("인천", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus11') onmouseout=mus_off('mus11') onclick=smenu_click('mus11')>
<img src='map/m032.gif' alt='' border='0' name='mus11' class='list11' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("대전", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus12') onmouseout=mus_off('mus12') onclick=smenu_click('mus12')>
<img src='map/m042.gif' alt='' border='0' name='mus12' class='list12' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("광주", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus13') onmouseout=mus_off('mus13') onclick=smenu_click('mus13')>
<img src='map/m062.gif' alt='' border='0' name='mus13' class='list13' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("대구", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus14') onmouseout=mus_off('mus14') onclick=smenu_click('mus14')>
<img src='map/m053.gif' alt='' border='0' name='mus14' class='list14' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("울산", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus15') onmouseout=mus_off('mus15') onclick=smenu_click('mus15')>
<img src='map/m052.gif' alt='' border='0' name='mus15' class='list15' ></a>

<a href='localssList.jsp?local=<%=URLEncoder.encode("부산", "UTF-8")%>' onfocus='this.blur()' onmouseover=mus_on('mus16') onmouseout=mus_off('mus16') onclick=smenu_click('mus16')>
<img src='map/m051.gif' alt='' border='0' name='mus16' class='list16' ></a>        </div>
<%}%>