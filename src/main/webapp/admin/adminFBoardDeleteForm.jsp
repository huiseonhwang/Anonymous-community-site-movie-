...
<h1 style="text-align: center;">
	<a href="adminFBoardDeleteForm.jsp">관리자용 자유 게시판</a>
</h1>
...
<%
	...
	if(count > 0){
		...
		if(startPage > 10){%>
			<a href="adminFBoardDeleteForm.jsp?pageNum=<%=startPage-10%>">[이전]</a>
		<%}
		for(int i = startPage ; i <= endPage ; i++){
		%>	<a href="adminFBoardDeleteForm.jsp?pageNum=<%=i%>">[<%=i%>]</a> 	
	  <%}
		if(endPage < pageCount){%>
		<a href="adminFBoardDeleteForm.jsp?pageNum=<%=startPage + 10%>">[다음]</a>
	  <%}	
	}
%>
</div>
